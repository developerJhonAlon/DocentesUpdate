...
import ec.edu.espe.servidordocente.servicio.PublicacionServicio;
import java.io.File;
...
public class PublicacionBean implements Serializable{
    ...
    private PublicacionDTO publicacionModal;
    ...
    public PublicacionDTO getPublicacionModal() {
        return publicacionModal;
    }

    public void setPublicacionModal(PublicacionDTO publicacionModal) {
        this.publicacionModal = publicacionModal;
    }
    
    
    @PostConstruct
    public void inicializar(){
       this.publicaciones = this.publicacionServicio.encontrarPublicacionPorPersona(loginBean.getPersonaDTO().getPerIdPersona());
       
    }
    
    public void botonAceptar(){
        String mensaje = "";
        if (this.publicacionModal.getPubIdPublicacion() != null) {
            this.publicacionServicio.modificarPublicacion(this.publicacionModal);
            
            mensaje = "Información Editada";
        } else {
            this.publicacionModal.setPerIdPersona(this.loginBean.getPersonaDTO());
            this.publicacionServicio.registrarPublicacion(this.publicacionModal);
            //Renderizar la vista
            this.publicaciones = this.publicacionServicio.encontrarPublicacionPorPersona(loginBean.getPersonaDTO().getPerIdPersona());
    ...
    public void botonAgregar(){
        this.publicacionModal = new PublicacionDTO();
    }
